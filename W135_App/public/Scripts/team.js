...
//----------------------------------------------------------------------------------//
    ...
    const member3 = new Member (
        ...
        'Images/Jamie.jpeg', 
        // Fill in contribution here
        '- index.js (main contributor)',
        '- contact.js (partial contributor)',
        '- Pre-plan design (main contriutor)',
        '- Form file handling (main/sole contributor)',
        '- Trello organisation (partial contributor)',
        '-',
        '-',
        '-',
        '-',
